...
awful.util.tagnames = {  "Terminal", "Firefox", "Game" }
--awful.util.tagnames = {  "➊", "➋", "➌", "➍", "➎", "➏", "➐", "➑", "➒" }
--awful.util.tagnames = { "⠐", "⠡", "⠲", "⠵", "⠻", "⠿" }
...
client.connect_signal("manage", function (c)
    ...
    -- Makes new windows slaves not master^^^
    -- https://www.reddit.com/r/awesomewm/comments/bkoxfl/place_new_windows_at_top_of_stack/
